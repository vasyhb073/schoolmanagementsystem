...
<div class="content">
    ...
    <table border="1px">
        <tr>
            ...
            <th style="padding:20px; font-size:15px;">Delete Course</th>
...
?>
        ...
        <td style="padding:20px;">
            <?php echo "<a onClick=\"javascript:return confirm('Are You Sure TO Delete This?');\" class='btn btn-danger' href='view_courses.php?course_id={$info['id']}'>Delete</a>"; ?>
        </td>
</tr>
<?php
}
